...
const opcoesCores = [azulInverno, verdeCipreste, meiaNoite, estelar, rosaClaro ];
opcoesTamanho =  ['41mm', '45 mm'];
...
//mudar o titulo do produto de acordo com a opção
